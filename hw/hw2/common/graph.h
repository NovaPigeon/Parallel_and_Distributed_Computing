...
struct graph
{
    ...
    // The node reached by vertex i's first outgoing edge is given by outgoing_edges[outgoing_starts[i]].  
    // The edge length of outgoing_edges[i] is outgoing_edges_len[i];
    int* outgoing_starts;
    Vertex* outgoing_edges;
    int* outgoing_edges_len;
